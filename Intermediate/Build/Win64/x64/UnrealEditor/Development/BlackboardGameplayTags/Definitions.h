...
#define UE_PROJECT_NAME Meerkat
#define UE_TARGET_NAME MeerkatEditor
#define UE_MODULE_NAME "BlackboardGameplayTags"
#define UE_PLUGIN_NAME "BlackboardGameplayTags"
#define IMPLEMENT_ENCRYPTION_KEY_REGISTRATION() 
#define IMPLEMENT_SIGNING_KEY_REGISTRATION() 
#define DEPRECATED_FORGAME DEPRECATED
#define UE_DEPRECATED_FORGAME UE_DEPRECATED
#define BLACKBOARDGAMEPLAYTAGS_API DLLEXPORT
...
#define DDPI_EXTRA_SHADERPLATFORMS SP_XB1_SM5=40, SP_XBOXONE_SM5=34, SP_XSX_SM6=35, SP_PS4=36, SP_PS5=33, SP_GLSL_SWITCH=38, SP_GLSL_SWITCH_MOBILE=39,
#define DDPI_SHADER_PLATFORM_NAME_MAP { TEXT("XB1_SM5"), TEXT("XB1"), SP_XB1_SM5 },{ TEXT("XBOXONE_SM5"), TEXT("XboxOneGDK"), SP_XBOXONE_SM5 },{ TEXT("XSX_SM6"), TEXT("XSX"), SP_XSX_SM6 },{ TEXT("PS4"), TEXT("PS4"), SP_PS4 },{ TEXT("PS5"), TEXT("PS5"), SP_PS5 },{ TEXT("GLSL_SWITCH"), TEXT("Switch"), SP_GLSL_SWITCH },{ TEXT("GLSL_SWITCH_MOBILE"), TEXT("Switch"), SP_GLSL_SWITCH_MOBILE },
...
#define PLATFORM_WINGDK 0
#define PLATFORM_XBOXCOMMON 0
#define PLATFORM_XB1 0
#define PLATFORM_XBOXONE 0
#define PLATFORM_XBOXONEGDK 0
